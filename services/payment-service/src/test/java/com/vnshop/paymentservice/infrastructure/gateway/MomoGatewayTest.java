...
class MomoGatewayTest {
    ...
    void createsSignedPaymentRequest() {
        Payment payment = new Payment("PAY-1", "ORDER-1", "BUYER-1", new BigDecimal("120000.00"), Payment.Method.MOMO, PaymentStatus.PENDING, null, Instant.parse("2026-05-10T00:00:00Z"));
        CapturingMomoClient client = new CapturingMomoClient(new MomoCreateResponse("MOMOTEST", "PAY-1", "PAY-1", 120000, 1777777777777L, "Success", 0, "https://pay.example/PAY-1", "momo://pay/PAY-1", "qr"));
        ...
        assertThat(client.createRequest)
                ...
                .containsExactly("MOMOTEST", "PAY-1", "PAY-1", 120000L, "https://shop.example/payment/momo/return", "https://shop.example/payment/momo/ipn", "captureWallet", "vi");
    ...
    void parsesVerifiedIpnAsCompletedAndRejectsTampering() {
        ...
        MomoIpnRequest verifiedRequest = ipn("PAY-2", 2812345678L, 0, 120000L);
        ...
        assertThat(verification.paymentId()).isEqualTo("PAY-2");
