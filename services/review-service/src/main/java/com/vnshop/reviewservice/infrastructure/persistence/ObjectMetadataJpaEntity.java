...
@Entity
@Table(schema = "review_svc", name = "object_metadata")
@Getter
@Setter
@NoArgsConstructor
public class ObjectMetadataJpaEntity {
    ...
    static ObjectMetadataJpaEntity fromDomain(ObjectMetadata metadata) {
        ...
        entity.ownerType = "REVIEW";
        entity.ownerId = reviewIdFromKey(metadata.getKey());
    ...
    private static String reviewIdFromKey(String key) {
